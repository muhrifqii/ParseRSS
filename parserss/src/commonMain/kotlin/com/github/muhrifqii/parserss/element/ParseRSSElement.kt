...
internal interface PrefixNamedHolder {
    val prefix: String
    val name: String
    val value: String
 ...
 */
internal data class ParseRSSElement(override val prefix: String, override val name: String) :
    PrefixNamedHolder {
 ...
 */
internal data class ParseRSSAttribute(
